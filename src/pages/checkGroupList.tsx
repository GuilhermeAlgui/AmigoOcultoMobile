                ...
                users.map(us=>{
                    ...
                    if(groups.id !==0){
                        return(
                            <TouchableOpacity 
                            onPress={()=>{
                                const params = {id: groups.id, name: groups.name, leader: us.leader, wish: us.wish, userName: us.name, userId:us.id}
                            ...
                            style={styles.rectButton} key={`${groups.id}${us.group_id}${us.id}`}>
