...
export default function ViewGroup(params: ViewProps){
    ...
    async function startGroup(){
       ...
       if(response){
           ...
           if(userResponse){
               alert('Grupo iniciado com sucesso, abra o grupo novamente para saber seu amigo oculto')
               navigation.goBack()
           }
        ...
        <View style={styles.container}>
            ...
            <TouchableOpacity
                onPress={()=>{
                    ...
                    navigation.navigate('GroupList',params)}} style={styles.textContainer}>
                <Text style={styles.text}>
                    Pessoas da sala
                </Text>
            </TouchableOpacity>
            ...
            {params.route.params.leader ? (
                 <TouchableOpacity onPress={startGroup}
                 style={styles.confirmButton}

             >
                 <Text style={styles.confirmButtonText}>
                     Iniciar Amigo Oculto
                 </Text>
